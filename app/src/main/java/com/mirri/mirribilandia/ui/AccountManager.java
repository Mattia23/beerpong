...
import com.mirri.mirribilandia.ui.Utente;
import com.mirri.mirribilandia.util.Utilities;
...
public class AccountManager {
    ...
    public static final Utente getLoggedUser(final Context context) {
        try {
            ...
            final JSONObject jsonObject = new JSONObject(Utilities.readStringFromStream(inputStream));
