...
public class RestaurantListFragment extends ListFragment {
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        callback.onItemSelected(RestaurantContent.ITEMS.get(position).id);
    }
    ...
    private class RestaurantListAdapter extends BaseAdapter {
        ...
        @Override
        public int getCount() {
            return RestaurantContent.ITEMS.size();
        }

        @Override
        public Object getItem(int position) {
            return RestaurantContent.ITEMS.get(position);
        }

        @Override
        public long getItemId(int position) {
            return RestaurantContent.ITEMS.get(position).id.hashCode();
        }
        ...
        public View getView(int position, View convertView, ViewGroup container) {
            ...
            if(restaurantItem.distance != -1) {
                ((TextView) convertView.findViewById(R.id.article_subtitle)).setText("Distanza dall'attrazione attuale: " + restaurantItem.distance + " metri");
            } else {
